...
public final class CBWrapper extends JavaPlugin implements Listener {

  	private static Map<String, DummyPlayer> dummies;

    @Override
    public void onEnable() {
	  CBWrapper.dummies = new HashMap<String, DummyPlayer>();
    }
    @Override
			...
			if(args.length > 0) {
			   ...
			   if(world == null) {
			 	...
			 	if(dummies.containsKey(name)) {
				  ...
				  dummies.put(name, dummy = new DummyPlayer(name, getServer(), world, x, y, z));
				}
